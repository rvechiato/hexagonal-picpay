...
public class CreateTransactionUseCaseImpl implements CreateTransactionUseCase {
    ...
    public Transaction create(Transaction transaction) {
        return Optional.of(createTransactionGateway.create(transaction))
                .orElseThrow(() ->new TransferException(ErrorCodeEnum.TR0003.getMessage(), ErrorCodeEnum.TR0003.getCode()));
    }
}
